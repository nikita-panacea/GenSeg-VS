#!/bin/bash
# End-to-end GenSeg training on the Radpretation dataset
...
python running_files/train_end2end_radpretation.py \
    --model pix2pix \
    --is_train True \
    --cuda True \
    --gpu_ids 0 \
    --cuda_index 0 \
    --dataroot /home/omen/Documents/Rishabh/TrainingDataApp/TrainingData \
    --amp \
    --loss_lambda 1.0 \
    --n_epochs 5000 \
    --lr 2e-4 \
